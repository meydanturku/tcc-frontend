...
const Documentation = () => {
    return (
        <div className="card docs">
            ...
            <p>
                Ultima is an application template for Next.js based on the popular{' '}
...
"primeflex": "^3.3.0",                     //required: Utility CSS classes`}
            ...
            <h5>Structure</h5>
            <p>Ultima consists of a couple folders, demos and core has been separated so that you can easily remove what is not necessary for your application.</p>
            <p>
                There are three{' '}
    ...
    const model = [
        {
            ...
            <h4>Theme</h4>
            <p>
                Ultima provides 34 PrimeReact themes out of the box. Setup of a theme is simple by including the CSS of the theme to your bundle that are located inside <span className="text-primary font-medium">public/theme/</span>
